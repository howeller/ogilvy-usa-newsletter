			...
			<table class="email-container" align="center" border="0" cellspacing="0" cellpadding="0" role="presentation" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; vertical-align: top; width: 580px; max-width: 580px; margin: auto; font-size: 0px;">
				...
				<tr>
					<td class="mod-padding-lr" style="margin: 0;">
						<table class="mod-exec-wrapper" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; vertical-align: top; width: 100%;">
							<tr>
								...
								<th class="mod-exec-container mod-exec-img" align="left" dir="ltr" valign="top" width="125" style="width: 125px; max-width: 125px; padding-right: 30px;">
									<a href="{{$global->EXECUTIVE->LINKURL}}" target="_blank" style="text-decoration: none;">
										<img class="mod-exec-img mod-img-alt-txt" align="center" border="0" width="125" alt="{{$global->EXECUTIVE->TITLE}}" src="{{$global->EXECUTIVE->IMAGE}}" style="-ms-interpolation-mode: bicubic; border: 0; display: block; margin: 0; padding: 0; text-decoration: none; width: 125px; max-width: 125px;">
									</a>
								</th>
								{{/if}}
								<th class="mod-exec-container" align="left" dir="ltr" valign="top">
									...
									<p class="body-text" style="margin: 0; font-family: OgilvySans, Arial, sans-serif; font-size: 16px; line-height: 18px; color: #545659; font-weight: normal;">
